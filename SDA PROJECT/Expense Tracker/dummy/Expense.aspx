<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Expense.aspx.cs" Inherits="dummy.Expense1" %>
...
<body>
    ...
    <span class="icon"><i class="fas fa-sign-out-alt"></i></span>
     ...
     <div class="header">
        <h1 style="font-size:2rem">Expense Reports</h1>
    </div>
    <div class="main-content">
        <div class="buttons">
            <button class="btn btn-new-transaction" runat="server" onserverclick="NewEX">+ New Expense</button>
        ...
        <div class="history">
            <h3>History of Expense</h3>
                    <div class="auto-style1">
            <asp:GridView ID="GD" runat="server" AutoGenerateColumns="False" CssClass="table gridview" OnRowDeleting="Del_EXP" DatakeyNames="Name" OnRowCancelingEdit="Cancel_Up_EXP" OnRowEditing="Edit_Expense" OnRowUpdating="Up_Expense">
          <Columns>
    ...
    <asp:TemplateField HeaderText="Amount">
        ...
        <EditItemTemplate>
          ...
          <asp:TemplateField HeaderText="Expense User" Visible="false">
            <ItemTemplate>
                <asp:Label ID="lbl_ExpUser" runat="server" Text='<%#Eval("ExpUser") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
